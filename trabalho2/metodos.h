...
// Declarações das funções dos métodos numéricos
vector<vector<double>> calculaInversaJacobi(int n, vector<vector<double>> A, double epsilon, int iterMax, vector<DadosIteracao>* historico = nullptr);
vector<vector<double>> calculaInversaSeidel(int n, vector<vector<double>> A, double epsilon, int iterMax, vector<DadosIteracao>* historico = nullptr);
